...
class MDP:
    ...
    def __init__(self, nodes, edgePerNode):
        ...
        self.W = np.random.randint(nodes, size=(nodes, edgePerNode))
...
player = Player(nodes, edgePerNode, eps=0.05, gamma=0.95, Nepisodes=100, MaxEpiSteps=20, MinAlpha=0.01)
master = Master(Nstates=np.power(edgePerNode,nodes), Nactions=nodes, eps=0.1, gamma=0.95, Nepisodes=10, MaxEpiSteps=10, MinAlpha=0.01)
